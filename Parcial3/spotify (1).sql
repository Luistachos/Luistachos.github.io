...
--
-- Table structure for table `membrecias`
--
...
--
-- Dumping data for table `membrecias`
--
...
INSERT INTO `playlist` (`id`, `nombre`, `usuarios_id`, `duracion`, `total_canciones`, `descripcion`, `publico`) VALUES
(1, 'luis...', 1, '04:23:54', 250, 'mi playlist', 2),
(2, 'canciones perronas', 5, '10:20:00', 6, 'canciones del beto', 1),
(3, 'rock', 7, '01:00:00', 32, 'canciones de rock para estudiar', 2),
(4, 'luis...', 1, '04:23:54', 250, 'playlist de luisito', 2),
(5, 'playlist perrona', 7, '10:20:00', 6, 'playlist para trabajar', 1),
(6, 'canciones bachatadas', 5, '01:00:00', 32, 'canciones que escucho namas porque si', 2);
...
--
-- AUTO_INCREMENT for table `membrecias`
--
ALTER TABLE `membrecias`
